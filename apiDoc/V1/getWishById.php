    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>string</td>
                <td>Ні</td>
                <td>Перелік полів для повернення. Можна вказати кілька через кому. <br>Доступні значення: <code>all</code>, <code>id</code>, <code>created_at</code>, <code>user_id</code>, <code>name</code>, <code>price</code>, <code>link</code>, <code>jar</code>, <code>priority</code>, <code>visibility</code>, <code>desc</code>, <code>img</code></td>
            </tr>
        </tbody>
    </table>
